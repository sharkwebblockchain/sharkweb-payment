...
import qr from '../Images/xrpLogo.png'
...
export default class xrp extends Component {
    ...
    render() {
        return (
            ...
            <br/>
            <center>
                <p style={{fontSize:'24px',fontWeight:'600'}}>Pay with XRP</p>
                <img src={qr} style={{height:'20vh'}}/>
                <p style={{fontSize:'20px',fontWeight:'500',marginTop:'15px'}}>Your <span style={{color:'#3d3dc6'}}>XRP</span> address</p>
