...
import qr from '../Images/aifiLogo.png'
import Logo from '../Images/Logo2.png'
export default class aifi extends Component {
    ...
    render() {
        return (
            ...
            <br/>
            <center>
                <p style={{fontSize:'24px',fontWeight:'600'}}>Pay with AIFI</p>
                <img src={qr} style={{height:'20vh'}}/>
                <p style={{fontSize:'20px',fontWeight:'500',marginTop:'15px'}}>Your <span style={{color:'#3d3dc6'}}>AIFI</span> address</p>
